...
<style>
    ...
    .col-id { width: 80px; max-width: 80px; }
    .col-shift { width: 80px; max-width: 80px; }
    .col-waktu { min-width: 150px; }
    .col-aksi { min-width: 120px; text-align: center; }

    /* Typography */
    .date-text { font-weight: 500; font-size: 0.85rem; line-height: 1.2; }
    .time-text { font-size: 0.75rem; }

    /* Tombol Modal */
    .btn-confirm-delete {
        background-color: #dc3545; color: white; border: none; padding: 8px 20px;
        border-radius: 6px; font-weight: 500; transition: all 0.2s;
    }
    .btn-confirm-delete:hover { background-color: #c82333; }

    .btn-cancel-modal {
        background-color: var(--input-bg, #f3f4f6); color: var(--black-color, #333);
        border: 1px solid var(--gray-border, #ccc); padding: 8px 20px;
        border-radius: 6px; font-weight: 500; transition: all 0.2s;
    }
</style>
@endpush
                            ...
                            <tr class="body">
                                ...
                                <td class="col-waktu">
                                    <div class="d-flex flex-column">
                                        ...
                                        <span class="text-muted small time-text">
                                            {{-- MODIFIED: Menggunakan Zona Waktu WITA (Asia/Makassar) --}}
                                            {{ $report->created_at->setTimezone('Asia/Makassar')->format('H:i') }} WITA
                                        </span>
                                    </div>
                                </td>
                                <td class="col-shift">
                                ...
                                <td class="col-aksi">
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <!-- Download -->
                                        <a href="{{ route('admin.report.view', $report->id) . '?action=download' }}"
                                           class="btn-aksi btn-download-trigger"
                                           title="Download"
                                           style="color: var(--orange-kss);">
...
<script>
    ...
    // Logic untuk Loading Indicator pada tombol Download

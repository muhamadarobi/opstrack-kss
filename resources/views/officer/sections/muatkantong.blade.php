<div id="section-muat-kantong" class="form-section">
    <div class="box-form-shift d-flex flex-column align-items-start align-self-stretch">
        <span class="title-form">i. pemuatan pupuk kantong</span>
        ...
        <div id="activity-content-4" class="activity-pane"></div>

    </div>

    <div class="button-form d-flex justify-content-between align-items-center align-self-stretch">
        <div class="btn previous" onclick="showSection('section-info-umum')">Kembali</div>
        <div class="btn save" onclick="showSection('section-muat-urea')">Lanjut</div>
    </div>
</div>

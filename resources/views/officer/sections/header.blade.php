<div class="content-header d-flex justify-content-between align-items-start align-self-stretch">
    <div class="title-content d-flex flex-column align-items-start" style="gap: 6px;">
        <span class="title-text align-self-stretch" style="font-size: 20px; font-weight: 600; ">Form Laporan Shift Harian</span>
        <span class="id-laporan" style="font-size: 14px; font-weight: 400; ">ID Laporan: #123</span>
    </div>
